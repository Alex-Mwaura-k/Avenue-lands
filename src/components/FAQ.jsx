...
const FAQ = () => {
  return (
    <section id="faq" className="pt-3 pb-5 blue-background overflow-hidden">
      ...
      <div className="container-md">
        ...
        <div className="mb-2">
          ...
          <h2 className="display-6 fw-bold text-white mt-2">
            <span className="text-stroke-light">FAQs</span>
          </h2>
          <p className="light-text" style={{ maxWidth: "600px" }}>
            Everything you need to know about buying land with Avenue Ventures.
          </p>
        </div>
          ...
          <div className="col-lg-6 d-none d-lg-block">
            <div className="h-100 position-relative">
              <img
                ...
                style={{ objectFit: "fit" }}
              />
              <div className="orange-background position-absolute bottom-0 start-0 p-2 text-white m-4 rounded shadow">
              ...
              {faqData.map((faq, index) => (
                ...
                >
                  <h2 className="accordion-header">
                    <button
                      className="accordion-button collapsed fw-bold text-white orange-background py-4"
                      type="button"
