            ...
            <div className="bg-white py-md-4 px-md-5 py-2 px-3 rounded shadow-sm">
              ...
              <section className="mb-4">
                ...
                <p>
                  ...
                  (“you”) and <strong>Avenue Ventures Ltd</strong>, concerning
                  your access to and use of the{" "}
                  <strong>Avenuelandventures.co.ke</strong> website as well as
              ...
              <section className="mb-4">
                ...
                <p>
                  Avenue Ventures offers flexible payment plans for most
                  properties.
                </p>
                <ul>
                  <li>
              ...
              <section className="mb-4">
                ...
                <address className="text-muted border-start border-4 border-danger ps-3">
                  ...
                  <br />
                  Email:{" "}
                  <a href="mailto:Avenuelandventures@gmail.com">
                    Avenuelandventures@gmail.com
                  </a>
                </address>
              </section>
            </div>
